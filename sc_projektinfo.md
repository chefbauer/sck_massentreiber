...
| 2026-06-18 (session) | — | **Beckenlicht reaktiviert**: `light_slots_becken` wieder aktiv auf GPIO3 (`pin_pwm3`); WS2815-Level-Shifter-Warnung bleibt bestehen (GPIO3 ist kein MIPI-Pin → weniger kritisch als GPIO5) | `lights.yaml`, `lvgl_basis.yaml` |
